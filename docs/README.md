...
|----------|-------------|
| [architecture.md](architecture.md) | Control / data / state planes |
| [architecture.zh-CN.md](architecture.zh-CN.md) | 架构（中文） |
| [comparison.md](comparison.md) | vs Kamailio, OpenSIPS, sipgo, … |
| [comparison.zh-CN.md](comparison.zh-CN.md) | 对比（中文） |
| [design/gateway-patterns.md](design/gateway-patterns.md) | Borrow from APISIX / Traefik / Tyk / … |
| [design/gateway-patterns.zh-CN.md](design/gateway-patterns.zh-CN.md) | 网关模式借鉴（中文） |
